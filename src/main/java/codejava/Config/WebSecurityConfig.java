...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.cors()
				...
				.antMatchers("/admin/**","/", "/home","/index", "/login", "/logout", "/sanpham/**", "/api/**","/cart/**", "/register","/home/login","/type/**","/home/cart/**","/?lang=vi","/?lang=en","/contact").permitAll() // Cho phep tat ca truy cap link nay
